...
HD_PWD='D:/Vivado Lab projects/barrel_shifter/barrel_shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_barrel_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_barrel_shifter.tcl
