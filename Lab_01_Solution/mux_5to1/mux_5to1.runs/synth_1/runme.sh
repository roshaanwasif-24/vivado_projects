...
HD_PWD='D:/Vivado Lab projects/mux_5to1/mux_5to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_5to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_5to1.tcl
