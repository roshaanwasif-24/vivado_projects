...
HD_PWD='D:/Vivado Lab projects/mux_5to1/mux_5to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_5to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_5to1.tcl -notrace
