...
HD_PWD='D:/Vivado Lab projects/priority_encoder_4to1/priority_encoder_4to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_4to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_4to1.tcl
