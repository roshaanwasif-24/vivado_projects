...
HD_PWD='D:/Vivado Lab projects/priority_encoder_4to1/priority_encoder_4to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_4to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_4to1.tcl -notrace
