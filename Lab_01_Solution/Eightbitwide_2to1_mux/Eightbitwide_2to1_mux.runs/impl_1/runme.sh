...
HD_PWD='D:/Vivado Lab projects/Eightbitwide_2to1_mux/Eightbitwide_2to1_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eightbitwide_2to1_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eightbitwide_2to1_mux.tcl -notrace
