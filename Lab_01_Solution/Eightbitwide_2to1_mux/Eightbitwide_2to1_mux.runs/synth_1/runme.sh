...
HD_PWD='D:/Vivado Lab projects/Eightbitwide_2to1_mux/Eightbitwide_2to1_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eightbitwide_2to1_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eightbitwide_2to1_mux.tcl
